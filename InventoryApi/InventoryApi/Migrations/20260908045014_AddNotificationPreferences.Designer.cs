...
namespace InventoryApi.Migrations
{
    ...
    [Migration("20260908045014_AddNotificationPreferences")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryApi.Models.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryApi.Models.TaskHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryApi.Models.TaskItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryApi.Models.User", b =>
                {
                    ...
                    b.Property<bool>("NotifyPurchase")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyTask")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifyUserRequest")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("InventoryApi.Models.TaskHistory", b =>
                {
                    b.HasOne("InventoryApi.Models.User", "ChangedByUser")
                        .WithMany()
                        .HasForeignKey("ChangedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InventoryApi.Models.TaskItem", "Task")
                        .WithMany("History")
            ...
            modelBuilder.Entity("InventoryApi.Models.TaskItem", b =>
                {
                    b.HasOne("InventoryApi.Models.User", "AssignedToUser")
                        .WithMany()
